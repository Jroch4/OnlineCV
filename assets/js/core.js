    ...
    Basic: {
        ...
        map: function() {
            ...
            function mapInitialize() {
                ...
                var myOptions = {
                    zoom: 14,
                    center: new google.maps.LatLng(yourLatitude,window.innerWidth<768?-8.302596:yourLongitude-.03),
                ...
                if ($contactForm.valid()){
                    $.ajax({
                        ...
                        success: function(msg) {
                            if (msg === 'SEND') {
                                response = '<div class="alert alert-success">Done! Thank you for your message. I\'ll get in touch as soon as possible.';
                            }
                            else {
                                response = '<div class="alert alert-danger">Ooops.. It seems that we have a problem. Please contact me throught your favorite email client.';
                            }
